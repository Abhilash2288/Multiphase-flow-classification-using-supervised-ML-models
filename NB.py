...
# Define Naive Bayes model with the specified hyperparameter
nb_model = GaussianNB(var_smoothing=2.1847457623086753e-5)
...
plt.title("Aggregated Confusion Matrix for Naive Bayes (Normalized)")
plt.show()
